# cypr0's .zshrc file.
# https://github.com/cypr0/mac-setup/zsh/
# Based on https://github.com/lucascosti/mac-config/zsh/
...
export ZSH_ADDONS_DIR=$HOME/Documents/Repos/mac-setup/zsh/addons
...
export CHEAT_CONFIG_PATH="$ZSH_ADDONS_DIR/miscdotfiles/cheat/conf.yml"
...
alias cdm='cd ~/Documents/Repos/mac-setup/'
alias cdk='cd ~/Documents/Repos/k3s-fleet/'
### Kubectl aliases
